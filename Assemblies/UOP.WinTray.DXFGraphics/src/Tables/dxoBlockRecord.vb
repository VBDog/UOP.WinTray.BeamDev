...
#Region "Constructors"
        ...
        Friend Sub New(aEntry As TTABLEENTRY)
            MyBase.New(dxxReferenceTypes.BLOCK_RECORD, aEntry.Name, aGUID:=aEntry.GUID)
            If aEntry.EntryType = dxxReferenceTypes.BLOCK_RECORD Then
                Properties.CopyVals(aEntry)
            End If
        End Sub
        Public Sub New(aName As String)
            MyBase.New(dxxReferenceTypes.BLOCK_RECORD, aName)
        End Sub
        Public Sub New(aEntry As dxoBlockRecord)
            MyBase.New(aEntry)
        End Sub
...
#Region "Methods"
        ...
        Public Shadows Function Clone() As dxoBlockRecord
            Return New dxoBlockRecord(Me)
        End Function
