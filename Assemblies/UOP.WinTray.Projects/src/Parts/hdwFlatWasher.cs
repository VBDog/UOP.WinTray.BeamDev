...
namespace UOP.WinTray.Projects.Parts
{
    /// <summary>
    /// flat washer object
    /// dimensions are set when the size propery is set
    /// </summary>
    public class hdwFlatWasher :  uopHardware
    {

        public override uppPartTypes BasePartType => uppPartTypes.FlatWasher;

        public hdwFlatWasher(uppHardwareSizes aSize = uppHardwareSizes.M10, uopHardwareMaterial aMaterial = null, int aQuantity = 1) : base(uppHardwareTypes.FlatWasher, aSize,aMaterial, aQuantity) { }


        internal hdwFlatWasher(uopHardware aParent, int aQuantity = 0) : base(uppHardwareTypes.FlatWasher, aParent.Size, aParent.HardwareMaterial, (aQuantity > 0) ? aQuantity : aParent.Quantity)
        {
            SubPart(aParent);
        ...
        /// </summary>
        /// <returns></returns>
        public hdwFlatWasher Clone(int aQuantity = 0) => new hdwFlatWasher(this, aQuantity);
        ...
        public bool IsEqual(hdwFlatWasher aPart) => uopHardware.Compare(this, aPart);
