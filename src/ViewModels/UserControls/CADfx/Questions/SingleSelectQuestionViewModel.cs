...
{
    public class SingleSelectQuestionViewModel : QuestionViewModelBase, INotifyPropertyChanged, IQuestionViewModel
    {
        private mzQuestion question;
        private SingleSelectQuestionView userControl;
        ...
        {
            this.userControl = userControl as SingleSelectQuestionView;
