...
namespace UOP.WinTray.UI.Events.EventAggregator
{
    ...
    internal class Subscriber : DisposableObject
	{
		...
		private Dictionary<Type, MethodInfo> eventHandlingMethods = new();
		...
		{
			return this.eventHandlingMethods != null && this.eventHandlingMethods.ContainsKey(messageType);
		}
		...
		protected override void Dispose(bool disposing)
		{
			if (disposing)
			{
				...
				if (this.eventHandlingMethods != null)
				{
